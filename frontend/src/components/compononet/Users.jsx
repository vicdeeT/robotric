    ...
    return (
        <div className="bg-blue-900">
            <div className="min-h-screen bg-blue-950/50">
                <aside className="bg-gradient-to-br from-blue-900 to-blue-950 -translate-x-80 fixed inset-0 z-50 my-4 ml-4 h-[calc(100vh-32px)] w-72 rounded-xl transition-transform duration-300 xl:translate-x-0">
                    ...
                    <div className="m-4">
                        <ul className="mb-4 flex flex-col gap-1">
                            ...
                            <li>
                                <a className="" href="/dashdarkX/users">
                ...
                {!Users ? "No Data is Found" : <div className="p-4 xl:ml-80">
                    <nav className="block w-full max-w-full bg-transparent text-white shadow-none rounded-xl transition-all px-0 py-1">
                        <div className="flex justify-between my-4">
                            ...
                            <div className="flex space-x-2 items-center">
                                <div></div>
                                <input type="search" className="border-none rounded-md h-9 outline-none text-blue-950 px-3" name="search" value={searchTerm} onChange={handleChange} placeholder="Search by Email" />
                                <button className="bg-blue-500 text-white hover:bg-blue-700 rounded-md px-3 py-2" onClick={handleSearch}>Search</button>
                            </div>
                        </div>
